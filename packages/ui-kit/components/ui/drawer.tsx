    ...
    >
      {showCloseButton && (
        <DrawerPrimitive.Close className={cn(
          ...
          closeButtonPosition === "top-right" && "right-4 top-4",
          closeButtonPosition === "top-left" && "left-4 top-4",
          closeButtonPosition === "bottom-right" && "right-4 bottom-4",
          closeButtonPosition === "bottom-left" && "left-4 bottom-4"
        )}>
          <X className="h-4 w-4" />
