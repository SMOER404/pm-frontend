...
export default function CustomInput({
  ...
  const chamferStyles = createChamferStyles(
    chamferSize,
    states.isFocused ? "#AFEB0F" : 
    validationError || externalError ? "#EF4444" : 
    "#292D30"
  )
  ...
  const getColors = () => {
    ...
    return {
      border: "#292D30",
      background: variant === "filled" ? "#F8F9FA" : "#FFFFFF",
      text: "#292D30",
    }
  }
      ...
      <div className="relative">
        ...
        >
          <div className="relative flex items-center">
            {/* Left Icon */}
            {hasLeftIcon && (
              <div className="absolute left-4 z-10 text-gray-400 flex items-center mr-2">
                {iconElement}
              </div>
            )}
