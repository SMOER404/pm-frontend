...
export const ProductsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getProductBySlug: async (slug: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/products/slug/{slug}`
...
export const ProductsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getProductBySlug(slug: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ProductResponseDto>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getProductBySlug(slug, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ProductsApi.getProductBySlug']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
...
export const ProductsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getProductBySlug(slug: string, options?: RawAxiosRequestConfig): AxiosPromise<ProductResponseDto> {
...
export class ProductsApi extends BaseAPI {
    ...
    public getProductBySlug(slug: string, options?: RawAxiosRequestConfig) {
        return ProductsApiFp(this.configuration).getProductBySlug(slug, options).then((request) => request(this.axios, this.basePath));
    }
