...
export const SearchApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getSearchSuggestionsApiV1SearchSuggestionsGet(query: string, limit?: number, options?: RawAxiosRequestConfig): AxiosPromise<Array<string | null>> {
            return localVarFp.getSearchSuggestionsApiV1SearchSuggestionsGet(query, limit, options).then((request) => request(axios, basePath));
        },
        /**
         * Умный поиск с фильтрами
         * @summary Smart Search
         ...
         * @throws {RequiredError}
         */
        smartSearchApiV1SearchGet(query: string, category?: string | null, minPrice?: number | null, maxPrice?: number | null, page?: number, perPage?: number, options?: RawAxiosRequestConfig): AxiosPromise<SearchResponse> {
            return localVarFp.smartSearchApiV1SearchGet(query, category, minPrice, maxPrice, page, perPage, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class SearchApi extends BaseAPI {
     ...
     * @memberof SearchApi
     */
    public getSearchSuggestionsApiV1SearchSuggestionsGet(query: string, limit?: number, options?: RawAxiosRequestConfig) {
        return SearchApiFp(this.configuration).getSearchSuggestionsApiV1SearchSuggestionsGet(query, limit, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof SearchApi
     */
    public smartSearchApiV1SearchGet(query: string, category?: string | null, minPrice?: number | null, maxPrice?: number | null, page?: number, perPage?: number, options?: RawAxiosRequestConfig) {
        return SearchApiFp(this.configuration).smartSearchApiV1SearchGet(query, category, minPrice, maxPrice, page, perPage, options).then((request) => request(this.axios, this.basePath));
    }
}
